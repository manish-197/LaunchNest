    ...
    <div className="create-page">
      <div className="form-wrapper">
        <div className="form-header">
          <h1>Update <span>Startup</span></h1>
        ...
        <form className="startup-form" onSubmit={handleSubmit}>
          <div className="form-grid">
            ...
            <div className="form-group">
              ...
              <input type="text" name="founderName" value={formData.founderName} disabled />
            </div>
            ...
            <div className="form-group">
              ...
              <input type="number" name="fundingGoal" value={formData.fundingGoal} onChange={handleChange} required />
            </div>
          </div>
          ...
          <div className="button-group" style={{ display: 'flex', gap: '10px' }}>
            ...
            <button type="button" className="cancel-btn" onClick={() => navigate('/profile')} 
              style={{ background: '#e2e8f0', color: '#475569', padding: '12px 25px', borderRadius: '12px', border: 'none', cursor: 'pointer' }}>
              Cancel
            </button>
          </div>
        </form>
